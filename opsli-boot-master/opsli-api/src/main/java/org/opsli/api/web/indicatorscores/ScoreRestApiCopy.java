...
// * the License.
// */
//package org.opsli.api.web.indicatorscores;
//
...
// */
//public interface ScoreRestApiCopy {
//
//    /** 标题 */
//    String TITLE = "选股评分";
//    /** 子标题 */
//    String SUB_TITLE = "选股评分";
//
//    /**
//    * 选股评分 查一条
//    * @param model 模型
...
//    */
//    @GetMapping("/get")
//    ResultWrapper<ScoreModel> get(ScoreModel model);
//
//    /**
//    * 选股评分 查询分页
//    * @param pageNo 当前页
...
//    */
//    @PostMapping("/insert")
//    ResultWrapper<?> insert(@RequestBody ScoreModel model);
//
//    /**
//    * 选股评分 修改
//    * @param model 模型
...
//    */
//    @PostMapping("/update")
//    ResultWrapper<?> update(@RequestBody ScoreModel model);
//
//    /**
//    * 选股评分 删除
//    * @param id ID
