...
public class ScoreWebQueryBuilder {
     ...
     */
    public ScoreWebQueryBuilder(Map<String, String[]> parameterMap){
     ...
     * @param parameterMap request 参数
     */
    public ScoreWebQueryBuilder(Map<String, String[]> parameterMap, WebQueryConf conf){
        this.parameterMap = parameterMap;
        this.defaultOrderField = MyBatisConstants.FIELD_UPDATE_TIME;
        this.conf = conf;
    }
